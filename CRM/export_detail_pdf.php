...
// ============================================
// SIGNATURE / APPROVAL - 5 level sesuai detailtr.php
// ============================================
$html .= '
<div class="section">H. APPROVAL / SIGNATURE</div>
<table class="signature">
    ...
    <tr>
        ...
        <td class="signature-role">Direktur Sales</td>
        <td class="signature-role">Divisi Business</td>
        <td class="signature-role">Direktur Operasional</td>
        <td class="signature-role">Direktur Utama</td>
    </tr>
</table>
...
<div class="note" style="margin-top:3px;">
    Catatan: Isi PDF mengikuti field dan perhitungan yang digunakan pada detailtr.php. Field yang tidak digunakan oleh detailtr.php tidak ditampilkan di PDF.
</div>
