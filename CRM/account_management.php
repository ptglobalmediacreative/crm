...
/* ACCOUNT MANAGEMENT — page-specific components only */
...
.badge-badan-usaha,.badge-sales,.badge-lead{display:inline-flex;align-items:center;padding:5px 9px;border-radius:999px;font-size:8px;font-weight:700;white-space:nowrap;border:1px solid transparent}
.badge-badan-usaha{background:rgba(34,211,238,.10);color:#67e8f9;border-color:rgba(34,211,238,.15)}
.badge-sales{background:rgba(251,191,36,.10);color:#fcd34d;border-color:rgba(251,191,36,.15);max-width:180px;overflow:hidden;text-overflow:ellipsis}
.badge-sales i{margin-right:5px}
.badge-lead.call{background:rgba(96,165,250,.10);color:#93c5fd;border-color:rgba(96,165,250,.15)}
.badge-lead.chat{background:rgba(52,211,153,.10);color:#6ee7b7;border-color:rgba(52,211,153,.15)}
.badge-lead.meeting{background:rgba(167,139,250,.10);color:#c4b5fd;border-color:rgba(167,139,250,.15)}
.badge-lead.canvasing{background:rgba(251,191,36,.10);color:#fcd34d;border-color:rgba(251,191,36,.15)}
.badge-lead.referensi{background:rgba(34,211,238,.10);color:#67e8f9;border-color:rgba(34,211,238,.15)}
.badge-lead.website{background:rgba(251,113,133,.10);color:#fb7185;border-color:rgba(251,113,133,.15)}
.btn-action.edit{background:rgba(96,165,250,.10);color:#60a5fa;border-color:rgba(96,165,250,.12)}
.btn-action.edit:hover{background:rgba(96,165,250,.18)}
.btn-action.edit-npwp{background:rgba(251,191,36,.10);color:#fcd34d;border-color:rgba(251,191,36,.12)}
.btn-action.edit-npwp:hover{background:rgba(251,191,36,.18)}
.form-label .optional{font-weight:400;color:#64748b;font-size:9px}
.form-control-file{font-size:10px}
.referensi-field{display:none}.referensi-field.show{display:block}
.detail-item{display:flex;padding:10px 0;border-bottom:1px solid rgba(148,163,184,.10)}
.detail-item:last-child{border-bottom:none}
.detail-item .detail-label{font-weight:700;color:#8e9bb5;width:140px;flex-shrink:0;font-size:10px}
.detail-item .detail-value{color:#dbe5f5;font-size:11px;word-break:break-word}
@media(max-width:1050px){.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:480px){.stat-grid{grid-template-columns:1fr}.stat-card{min-height:100px;padding:14px}.detail-item{flex-direction:column}.detail-item .detail-label{width:100%;margin-bottom:3px}}
</style>
</head>';
    echo '<body>';
