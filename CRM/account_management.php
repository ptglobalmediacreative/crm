...
<style>
/* Exact Sales Activity visual system for Account Management */
...
/* Account-specific components using the same Sales Activity visual language */
.stat-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-bottom:22px}.stat-card{background:linear-gradient(145deg,rgba(11,18,34,.96),rgba(8,15,29,.96));border:1px solid var(--line);border-radius:14px;padding:17px 18px;box-shadow:0 10px 28px rgba(0,0,0,.16);transition:.2s}.stat-card:hover{transform:translateY(-2px);border-color:rgba(96,165,250,.32);box-shadow:0 16px 35px rgba(0,0,0,.22)}.stat-card .stat-icon{width:38px;height:38px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:14px;margin-bottom:12px}.stat-card .stat-icon.gold{background:rgba(251,191,36,.10);color:#fbbf24}.stat-card .stat-icon.blue{background:rgba(96,165,250,.10);color:#60a5fa}.stat-card .stat-icon.green{background:rgba(52,211,153,.10);color:#34d399}.stat-card .stat-icon.purple{background:rgba(167,139,250,.10);color:#a78bfa}.stat-card .stat-number{font-size:22px;font-weight:800;color:#f7f9ff;line-height:1.1;margin-bottom:4px}.stat-card .stat-label{font-size:9px;color:#66758f;text-transform:uppercase;letter-spacing:.8px;font-weight:700}
.badge-lead,.badge-sales,.badge-badan-usaha{display:inline-flex;align-items:center;padding:5px 9px;border-radius:999px;font-size:8px;font-weight:700;white-space:nowrap;border:1px solid transparent}.badge-lead.call{background:rgba(96,165,250,.10);color:#93c5fd;border-color:rgba(96,165,250,.15)}.badge-lead.chat{background:rgba(52,211,153,.10);color:#6ee7b7;border-color:rgba(52,211,153,.15)}.badge-lead.meeting{background:rgba(167,139,250,.10);color:#c4b5fd;border-color:rgba(167,139,250,.15)}.badge-lead.canvasing{background:rgba(251,191,36,.10);color:#fcd34d;border-color:rgba(251,191,36,.15)}.badge-lead.referensi{background:rgba(34,211,238,.10);color:#67e8f9;border-color:rgba(34,211,238,.15)}.badge-lead.website{background:rgba(251,113,133,.10);color:#fb7185;border-color:rgba(251,113,133,.15)}.badge-sales{background:rgba(96,165,250,.10);color:#93c5fd;border-color:rgba(96,165,250,.14)}.badge-badan-usaha{background:rgba(167,139,250,.10);color:#c4b5fd;border-color:rgba(167,139,250,.14)}
.footer-text{margin-top:20px;text-align:center;color:#44536c;font-size:9px}.footer-text a{color:#6b7a94}
@media(max-width:1050px){.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:800px){.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.content{padding:20px 14px 40px}.hero-row{align-items:flex-start;flex-direction:column}.header-actions{width:100%}.header-actions a,.header-actions button{flex:1}}
@media(max-width:480px){.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.stat-card{padding:14px}.content{padding:18px 10px 35px}.hero h1{font-size:22px}}
</style>
</head>';
    echo '<body>';
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .brand strong{display:block;font-size:13px;font-weight:800;letter-spacing:.1px;}
        .brand small{display:block;color:#738096;font-size:9px;margin-top:2px;letter-spacing:.45px;}
        ...
        .avatar{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#1e3a8a,#2563eb);display:flex;align-items:center;justify-content:center;font-weight:800;font-size:12px;border:1px solid rgba(96,165,250,.5);color:#fff;}
        ...
        .content{margin-left:245px!important;padding:96px 28px 28px!important;width:auto!important;min-height:100vh;}
        ...
        .mobile-toggle{display:none;background:#0a1020;border:1px solid var(--line);color:#9fb0c8;width:38px;height:38px;border-radius:9px;margin-right:10px;}
        @media(max-width:991px){.mobile-toggle{display:flex;align-items:center;justify-content:center}.sidebar{transform:translateX(-100%)!important}.sidebar.open{transform:translateX(0)!important}.content{margin-left:0!important;padding:92px 18px 24px!important}.page-header>div:last-child{width:100%}.page-header>div:last-child{justify-content:flex-start;display:flex;flex-wrap:wrap}.sidebar{width:245px!important}}
        @media(max-width:480px){.brand strong{font-size:11px}.brand small{font-size:8px}.brand img{width:32px;height:32px}.content{padding:88px 12px 20px!important}.page-header h4{font-size:19px!important}.stat-grid{grid-template-columns:repeat(2,1fr)!important;gap:10px!important}.stat-card{padding:14px!important}.card-custom .card-header-custom{align-items:flex-start!important}.card-custom .card-header-custom form{width:100%!important}.card-custom .card-header-custom form input{width:100%!important}.table-custom{min-width:1050px!important}}
        ...
        /* =========================================================
           SALES ACTIVITY THEME — ACCOUNT MANAGEMENT
           Presentation only: existing account logic is untouched.
           ========================================================= */
        ...
        html{background:#060b18!important}
        body{font-family:Inter,Arial,sans-serif!important;background:radial-gradient(circle at 70% -10%,rgba(37,99,235,.20),transparent 30%),linear-gradient(145deg,#050914,#08111f 55%,#07162c)!important;color:var(--text)!important;min-height:100vh!important;overflow-x:hidden!important;padding-bottom:0!important}
        ...
        .brand{display:flex!important;align-items:center!important;gap:11px!important;text-decoration:none!important;color:#fff!important;min-width:220px!important}
        .brand img{width:38px!important;height:38px!important;object-fit:contain!important}.brand strong{font-size:17px!important;letter-spacing:-.4px!important}.brand small{display:block!important;color:#65738e!important;font-size:9px!important;text-transform:uppercase!important;letter-spacing:1.2px!important;margin-top:2px!important}
        ...
        .sidebar{top:72px!important;bottom:0!important;height:auto!important;width:245px!important;background:rgba(5,10,21,.92)!important;border-right:1px solid var(--line)!important;padding:22px 14px!important;z-index:1000!important;box-shadow:none!important;display:flex!important;flex-direction:column!important;gap:6px!important}
        .sidebar .brand{display:none!important}.sidebar .rail-label{font-size:9px!important;color:#52627d!important;text-transform:uppercase!important;letter-spacing:1.5px!important;font-weight:800!important;padding:8px 12px 7px!important}
        .sidebar .nav-item{width:100%!important;height:43px!important;border-radius:11px!important;color:#8794aa!important;display:flex!important;align-items:center!important;gap:12px!important;text-decoration:none!important;transition:.2s!important;padding:0 13px!important;font-size:11px!important;font-weight:600!important;margin:0!important}.sidebar .nav-item i{width:20px!important;text-align:center!important;font-size:14px!important;color:#6e7d97!important;margin:0!important}.sidebar .nav-item:hover,.sidebar .nav-item.active{color:#fff!important;background:linear-gradient(90deg,rgba(59,130,246,.20),rgba(37,99,235,.06))!important;box-shadow:inset 2px 0 0 #60a5fa!important}.sidebar .nav-item.active i{color:#60a5fa!important}.spacer{flex:1!important;min-height:20px!important}
        .sidebar .user-profile{margin:8px 4px 4px!important;padding:12px!important;border:1px solid rgba(148,163,184,.10)!important;background:rgba(10,18,34,.7)!important;border-radius:13px!important;display:flex!important;align-items:center!important;gap:10px!important}.sidebar .user-profile .avatar{width:32px!important;height:32px!important;border-radius:50%!important;background:linear-gradient(135deg,#1e3a8a,#2563eb)!important;display:flex!important;align-items:center!important;justify-content:center!important;color:#fff!important;font-size:11px!important;font-weight:800!important}.sidebar .user-profile .user-info .name{display:block!important;font-size:10px!important;color:#e8eef9!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}.sidebar .user-profile .user-info .role{display:block!important;font-size:8px!important;color:#66758f!important;margin-top:2px!important}.sidebar .logout-btn{display:flex!important;align-items:center!important;gap:10px!important;text-align:left!important;color:#8794aa!important;background:transparent!important;border:0!important;margin-top:0!important;padding:0 13px!important;height:43px!important;font-size:11px!important;text-decoration:none!important}.sidebar .logout-btn:hover{color:#fb7185!important;background:rgba(251,113,133,.08)!important;box-shadow:none!important}
        .content{margin-left:245px!important;padding:26px 28px 50px!important;width:calc(100% - 245px)!important;min-height:calc(100vh - 72px)!important}
        .page-header{display:flex!important;justify-content:space-between!important;align-items:flex-end!important;gap:20px!important;margin-bottom:22px!important}.page-header>div:first-child{display:block!important}.page-header>div:first-child>div:last-child{display:block!important}.page-header h4{font-size:26px!important;letter-spacing:-1px!important;font-weight:800!important;margin:0!important;color:#f7f9ff!important}.page-header h4 span{color:#60a5fa!important}.page-header h4 span i{color:#60a5fa!important}.page-header>div:last-child{display:flex!important;gap:8px!important;align-items:center!important;flex-wrap:wrap!important}.page-header .mobile-toggle{display:none!important}
        .btn-success-custom{height:38px!important;border:1px solid rgba(52,211,153,.25)!important;border-radius:11px!important;background:rgba(52,211,153,.08)!important;color:#6ee7b7!important;font-size:11px!important;font-weight:700!important;padding:0 14px!important;display:inline-flex!important;align-items:center!important;text-decoration:none!important}.btn-success-custom:hover{color:#a7f3d0!important;background:rgba(52,211,153,.14)!important;transform:translateY(-1px)!important}.btn-primary-custom{height:38px!important;border:0!important;border-radius:11px!important;background:linear-gradient(135deg,#3b82f6,#6366f1)!important;color:#fff!important;font-size:11px!important;font-weight:700!important;padding:0 15px!important;box-shadow:0 0 24px rgba(59,130,246,.25)!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;text-decoration:none!important}.btn-primary-custom:hover{color:#fff!important;transform:translateY(-1px)!important;box-shadow:0 0 28px rgba(59,130,246,.35)!important}
        .stat-grid{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:14px!important;margin-bottom:14px!important}.stat-card{background:linear-gradient(145deg,rgba(12,23,43,.94),rgba(7,14,28,.96))!important;border:1px solid var(--line)!important;border-radius:17px!important;box-shadow:0 18px 45px rgba(0,0,0,.18)!important;padding:18px!important;transition:.25s!important;color:#eaf0f8!important}.stat-card:hover{border-color:rgba(96,165,250,.35)!important;box-shadow:0 20px 48px rgba(0,0,0,.25)!important;transform:translateY(-1px)!important}.stat-card .stat-number{color:#f7f9ff!important;font-size:23px!important;font-weight:800!important}.stat-card .stat-label{color:#8290a5!important;font-size:11px!important}.stat-card .stat-icon{margin-bottom:10px!important}.stat-card .stat-icon.gold{background:rgba(212,160,23,.12)!important;color:#e0b53d!important}.stat-card .stat-icon.blue{background:rgba(59,130,246,.12)!important;color:#60a5fa!important}.stat-card .stat-icon.green{background:rgba(34,197,94,.12)!important;color:#4ade80!important}.stat-card .stat-icon.purple{background:rgba(168,85,247,.12)!important;color:#c084fc!important}
        .card-custom{background:linear-gradient(145deg,rgba(12,23,43,.94),rgba(7,14,28,.96))!important;border:1px solid var(--line)!important;border-radius:17px!important;box-shadow:0 18px 45px rgba(0,0,0,.18)!important;overflow:hidden!important;transition:.25s!important}.card-custom:hover{border-color:rgba(96,165,250,.35)!important;box-shadow:0 20px 48px rgba(0,0,0,.25)!important}.card-custom .card-header-custom{padding:15px 18px!important;border-bottom:1px solid rgba(148,163,184,.10)!important;display:flex!important;justify-content:space-between!important;align-items:center!important;flex-wrap:wrap!important;gap:12px!important}.card-custom .card-header-custom h6{font-weight:700!important;color:#f7f9ff!important;margin:0!important;font-size:13px!important}.card-custom .card-header-custom h6 i{color:#60a5fa!important;margin-right:8px!important}.card-custom .card-body-custom{padding:0!important;overflow-x:auto!important}
        .table-responsive{border-radius:0!important}.table-custom{margin-bottom:0!important;font-size:10px!important;color:#cbd5e1!important;--bs-table-bg:transparent!important;--bs-table-color:#cbd5e1!important}.table-custom th{font-weight:700!important;font-size:9px!important;text-transform:uppercase!important;letter-spacing:.45px!important;color:#66758f!important;border-bottom:1px solid rgba(148,163,184,.10)!important;padding:13px 14px!important;background:rgba(5,12,25,.48)!important;white-space:nowrap!important}.table-custom td{padding:13px 14px!important;vertical-align:middle!important;border-bottom:1px solid rgba(148,163,184,.07)!important;color:#cbd5e1!important;background:transparent!important}.table-custom tbody tr:hover td{background:rgba(59,130,246,.035)!important}.table-custom tr:last-child td{border-bottom:none!important}.table-custom td strong{color:#f7f9ff!important}.table-custom a{color:#60a5fa!important}.badge-badan-usaha,.badge-sales,.badge-lead{border-radius:999px!important;font-size:8px!important;font-weight:700!important;white-space:nowrap!important}
        .form-control,.form-select{border-radius:9px!important;padding:9px 11px!important;border:1px solid rgba(148,163,184,.16)!important;background:#0a1427!important;color:#dbe5f5!important;font-size:11px!important;transition:.2s!important}.form-control::placeholder{color:#52627d!important}.form-control:focus,.form-select:focus{border-color:rgba(96,165,250,.55)!important;box-shadow:0 0 0 3px rgba(59,130,246,.10)!important;background:#0b172d!important;color:#fff!important}.form-select option{background:#0b1222!important;color:#dbe5f5!important}.modal-content{background:linear-gradient(145deg,#0c172b,#07101f)!important;border:1px solid var(--line)!important;border-radius:15px!important;color:#dbe5f5!important;box-shadow:0 24px 70px rgba(0,0,0,.45)!important}.modal-header{border-bottom:1px solid rgba(148,163,184,.10)!important;padding:16px 20px!important}.modal-header .modal-title{font-weight:700!important;font-size:14px!important;color:#f7f9ff!important}.modal-header .modal-title i{color:#60a5fa!important}.modal-footer{border-top:1px solid rgba(148,163,184,.10)!important;padding:12px 20px!important}.modal-body{padding:18px 20px!important}.form-label{font-weight:600!important;font-size:11px!important;color:#aebbd0!important}.btn-close{filter:invert(1) grayscale(1)!important;opacity:.55!important}.text-muted{color:#64748b!important}.pagination .page-link{background:#0a1427!important;border:1px solid rgba(148,163,184,.12)!important;color:#8492aa!important;border-radius:8px!important;font-size:9px!important;padding:6px 9px!important}.pagination .page-item.active .page-link{background:#2563eb!important;border-color:#3b82f6!important;color:#fff!important}.footer-text{color:#44536c!important}.footer-text a{color:#6b7a94!important}
        @media(max-width:1050px){.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.content{padding:22px 20px 45px!important}.page-header{align-items:flex-start!important}.page-header>div:last-child{justify-content:flex-start!important}}
        @media(max-width:991px){.mobile-toggle{display:flex!important;align-items:center!important;justify-content:center!important}.sidebar{transform:translateX(-100%)!important}.sidebar.open{transform:translateX(0)!important}.content{margin-left:0!important;width:100%!important;padding:92px 18px 24px!important}.page-header>div:last-child{width:100%!important}.sidebar{width:245px!important}}
        @media(max-width:480px){.topbar{height:64px!important;padding:0 16px!important}.brand strong{font-size:11px!important}.brand small{font-size:8px!important}.brand img{width:32px!important;height:32px!important}.content{padding:88px 12px 20px!important}.page-header h4{font-size:22px!important}.stat-grid{grid-template-columns:repeat(2,1fr)!important;gap:10px!important}.stat-card{padding:14px!important}.card-custom .card-header-custom{align-items:flex-start!important}.card-custom .card-header-custom form{width:100%!important}.card-custom .card-header-custom form input{width:100%!important}.table-custom{min-width:1050px!important}}
</style>
</head>
<body>
    ...
    <nav class="rail" id="sidebar">
        ...
        <?php if (in_array('sales_activity', $menuNames)): ?>
            <a href="salesactivity.php" ><i class="fas fa-chart-line"></i><span>Sales Activity</span></a>
        <?php endif; ?>
        <?php if (in_array('account_management', $menuNames)): ?>
            <a href="account_management.php" class="active"><i class="fas fa-building"></i><span>Account Management</span></a>
        <?php endif; ?>
        ...
        <div class="rail-user"><div class="mini-avatar"><?= strtoupper(substr($fullName, 0, 1)) ?></div><div><strong><?= htmlspecialchars($fullName) ?></strong><span><?= getRoleLabel($role) ?></span></div></div>
        <a href="logout.php" class="logout-link"><i class="fas fa-power-off"></i><span>Logout</span></a>
    </nav>
    ...
    <div class="content">
        ...
        <section class="hero-row">
            <div class="hero">
                ...
                <p>Manage customer accounts, company information and sales ownership.</p>
            </div>
            <div class="header-actions">
                <a href="account_management.php?export=excel" class="btn-export"><i class="fas fa-file-excel me-2"></i>Export Excel</a>
                <?php if ($userRole === 'sales' || $isDirektur || canAdd('account_management')): ?>
                    <button class="btn-add" data-bs-toggle="modal" data-bs-target="#modalAccount"><i class="fas fa-plus me-2"></i>Tambah Account</button>
                <?php endif; ?>
            </div>
        </section>
