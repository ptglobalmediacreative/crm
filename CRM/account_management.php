...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .main-content{margin-left:245px!important;padding:26px 28px 50px!important;width:calc(100% - 245px)!important;min-height:calc(100vh - 72px)!important}
        ...
        @media(max-width:1050px){.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.main-content{padding:22px 20px 45px!important}.page-header{align-items:flex-start!important}.page-header>div:last-child{justify-content:flex-start!important}}
        @media(max-width:991px){.top-mobile-toggle{display:flex!important;align-items:center!important;justify-content:center!important}.sidebar{transform:translateX(-100%)!important}.sidebar.open{transform:translateX(0)!important}.main-content{margin-left:0!important;width:100%!important;padding:92px 18px 24px!important}.page-header>div:last-child{width:100%!important}.sidebar{width:245px!important}}
        @media(max-width:480px){.topbar{height:64px!important;padding:0 16px!important}.top-brand strong{font-size:11px!important}.top-brand small{font-size:8px!important}.top-brand img{width:32px!important;height:32px!important}.main-content{padding:88px 12px 20px!important}.page-header h4{font-size:22px!important}.stat-grid{grid-template-columns:repeat(2,1fr)!important;gap:10px!important}.stat-card{padding:14px!important}.card-custom .card-header-custom{align-items:flex-start!important}.card-custom .card-header-custom form{width:100%!important}.card-custom .card-header-custom form input{width:100%!important}.table-custom{min-width:1050px!important}}
</style>
</head>
<body>
