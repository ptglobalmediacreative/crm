...
.form-label .optional{font-size:9px;color:#64748b;font-weight:400;margin-left:3px}
.form-control-file{padding-top:8px;padding-bottom:8px}
.table-custom td:nth-child(9) .badge-sales{max-width:155px;overflow:hidden;text-overflow:ellipsis}
