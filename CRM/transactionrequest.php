...
/* =========================================================
   TRANSACTION REQUEST — VISUAL PARITY WITH ACCOUNT MANAGEMENT
   Presentation only. Existing PHP/DB/query/filter/pagination logic untouched.
   ========================================================= */
:root{
...
a{color:inherit}
.topbar{height:72px;position:fixed;top:0;left:0;right:0;z-index:1100;background:rgba(5,9,20,.88);backdrop-filter:blur(18px);border-bottom:1px solid var(--line);display:flex;align-items:center;padding:0 26px;gap:24px}
...
.top-brand strong{font-size:17px;letter-spacing:-.4px;font-weight:800}
...
.top-mobile-toggle{display:none}
.sidebar{width:245px;position:fixed;top:72px;bottom:0;left:0;height:auto;background:rgba(5,10,21,.92);border-right:1px solid var(--line);display:flex;flex-direction:column;padding:22px 14px;gap:6px;z-index:1000;overflow-y:auto;box-shadow:none}
...
.sidebar .menu-section{font-size:9px;color:#52627d;text-transform:uppercase;letter-spacing:1.5px;font-weight:800;padding:8px 12px 7px}
...
.sidebar-bottom{margin-top:auto!important;padding-top:0!important;border-top:0!important}
.sidebar .user-profile{margin:8px 4px 4px!important;padding:12px!important;border:1px solid rgba(148,163,184,.10)!important;background:rgba(10,18,34,.7)!important;border-radius:13px!important;display:flex!important;align-items:center!important;gap:10px!important}
...
.sidebar .logout-btn{width:100%!important;height:43px!important;border-radius:11px!important;color:#8794aa!important;background:transparent!important;border:0!important;display:flex!important;align-items:center!important;gap:10px!important;text-align:left!important;text-decoration:none!important;transition:.2s!important;padding:0 13px!important;margin-top:0!important;font-size:11px!important;font-weight:600!important;box-shadow:none!important}
.sidebar .logout-btn i{width:20px;text-align:center;font-size:14px;color:#6e7d97;margin:0}
...
.main-content{margin-left:245px;width:calc(100% - 245px);padding:26px 28px 50px;min-height:calc(100vh - 72px);max-width:none}
.page-header{display:flex;justify-content:space-between;align-items:flex-end;gap:20px;margin-bottom:22px;flex-wrap:wrap}
.page-header h1{font-size:26px;line-height:1.2;letter-spacing:-1px;font-weight:800;margin:0;color:#f7f9ff!important}
.page-header h1 i{font-size:19px;color:#60a5fa!important;margin-right:8px}
.page-header p{font-size:12px;color:var(--muted);margin-top:7px}
.eyebrow{font-size:10px;color:#6f80a0;text-transform:uppercase;letter-spacing:1.6px;font-weight:700;margin-bottom:7px}
...
.stat-card .stat-number{color:#f7f9ff;font-size:23px;font-weight:800}.stat-card .stat-label{color:#8290a5;font-size:11px}.stat-card .stat-icon{width:36px;height:36px;border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:14px;margin-bottom:10px}
.stat-card .stat-icon.gold{background:rgba(212,160,23,.12);color:#e0b53d}.stat-card .stat-icon.blue{background:rgba(59,130,246,.12);color:#60a5fa}.stat-card .stat-icon.green{background:rgba(34,197,94,.12);color:#4ade80}.stat-card .stat-icon.purple{background:rgba(168,85,247,.12);color:#c084fc}.stat-card .stat-icon.red{background:rgba(251,113,133,.10);color:#fb7185}
.card-custom{background:linear-gradient(145deg,rgba(12,23,43,.94),rgba(7,14,28,.96));border:1px solid var(--line);border-radius:17px;box-shadow:0 18px 45px rgba(0,0,0,.18);overflow:hidden;transition:.25s}
...
.card-header-custom input{background:#0a1427!important;border:1px solid rgba(148,163,184,.16)!important;color:#dbe5f5!important;border-radius:9px!important;font-size:11px}
.card-header-custom input::placeholder{color:#52627d}
.btn-primary-custom{background:linear-gradient(135deg,#3b82f6,#6366f1);border:0;border-radius:9px;padding:9px 15px;font-weight:700;font-size:11px;transition:.2s;color:#fff}.btn-primary-custom:hover{background:linear-gradient(135deg,#4f8df7,#6d70f3);transform:translateY(-1px);box-shadow:0 8px 22px rgba(59,130,246,.2);color:#fff}
.btn-secondary-custom{background:#111d31;border:1px solid rgba(148,163,184,.13);border-radius:9px;padding:9px 15px;font-weight:600;font-size:11px;color:#8f9db4;transition:.2s}.btn-secondary-custom:hover{background:#17253d;color:#fff;border-color:rgba(148,163,184,.22)}
...
.card-body-custom{padding:0}.table-responsive{background:transparent;border-radius:0}.table-custom{margin-bottom:0!important;width:100%;font-size:10px;color:#cbd5e1;--bs-table-bg:transparent;--bs-table-color:#cbd5e1;--bs-table-border-color:transparent}
.table-custom th{font-weight:700;font-size:9px;text-transform:uppercase;letter-spacing:.45px;color:#66758f!important;border-bottom:1px solid rgba(148,163,184,.10)!important;padding:13px 14px!important;background:rgba(5,12,25,.48)!important;white-space:nowrap}
.table-custom td{padding:13px 14px!important;vertical-align:middle;border-bottom:1px solid rgba(148,163,184,.07)!important;color:#cbd5e1!important;background:transparent!important}.table-custom tbody tr{transition:.15s}.table-custom tbody tr:hover td{background:rgba(59,130,246,.035)!important;color:#e8eef7!important}.table-custom tr:last-child td{border-bottom:none!important}.table-custom a{color:#60a5fa!important;text-decoration:none;font-weight:700}.table-custom a:hover{color:#93c5fd!important}.text-muted{color:#64748b!important}
.badge-status-tr{display:inline-flex;align-items:center;gap:5px;padding:5px 9px;border-radius:999px;font-size:8px;font-weight:700;white-space:nowrap;border:1px solid transparent}.badge-status-tr.pending{background:rgba(251,191,36,.10);color:#fcd34d;border-color:rgba(251,191,36,.15)}.badge-status-tr.approved{background:rgba(52,211,153,.10);color:#6ee7b7;border-color:rgba(52,211,153,.15)}.badge-status-tr.rejected{background:rgba(251,113,133,.10);color:#fb7185;border-color:rgba(251,113,133,.15)}
.btn-pdf{background:rgba(52,211,153,.10);border:1px solid rgba(52,211,153,.15);border-radius:8px;padding:6px 10px;color:#6ee7b7;text-decoration:none;display:inline-flex;align-items:center;gap:5px;font-size:9px;font-weight:700;transition:.2s}.btn-pdf:hover{color:#a7f3d0;background:rgba(52,211,153,.14);transform:translateY(-1px)}
.btn-pdf-disabled{background:rgba(100,116,139,.08);border:1px solid rgba(100,116,139,.12);border-radius:8px;padding:6px 10px;color:#59677d;display:inline-flex;align-items:center;gap:5px;font-size:9px;font-weight:700;cursor:not-allowed}
