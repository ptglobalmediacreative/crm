...
.table-custom th:first-child,.table-custom td:first-child{width:58px;text-align:center;color:#7f8da5}.table-custom th:nth-child(2){width:15%}.table-custom th:nth-child(3){width:23%}.table-custom th:nth-child(4){width:13%}.table-custom th:nth-child(5){width:13%}.table-custom th:nth-child(6){width:15%}.table-custom th:nth-child(7){width:11%}.table-custom th:nth-child(8){width:112px}.table-custom th:last-child,.table-custom td:last-child{width:112px;text-align:center}
.table-custom td strong{color:#e5edf8;font-weight:700;display:block;line-height:1.4}.account-name{color:#e5edf8!important;font-weight:700;line-height:1.35}.sales-name{color:#cbd5e1!important;font-weight:600}.date-cell{white-space:nowrap;color:#8998ae!important;font-variant-numeric:tabular-nums}.filter-buttons .btn-filter i{color:#8fa1ba}.filter-buttons .btn-filter.active i{color:#fff}.empty-state{padding:42px 20px!important;color:#53627a!important}.empty-state i{font-size:22px;display:block;margin-bottom:8px;color:#64748b}
                            ...
                            <?php if (count($deliveries) > 0): ?>
                                ...
                                <?php foreach ($deliveries as $delivery): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong class="account-name"><?= htmlspecialchars($delivery['nama_pt'] ?? '-') ?></strong></td>
                                        <td class="date-cell"><?= date('d/m/Y', strtotime($delivery['request_date'])) ?></td>
                                        <td class="date-cell"><?= date('d/m/Y', strtotime($delivery['due_date'])) ?></td>
                                        <td><span class="sales-name"><?= htmlspecialchars($delivery['sales_name'] ?? '-') ?></span></td>
                                        <td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-center empty-state">
                                        <i class="fas fa-inbox"></i> Belum ada data delivery instruction
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
