...
@media(max-width:1200px){.kpis{grid-template-columns:repeat(3,1fr)}.brand{min-width:190px}.search{width:150px}}@media(max-width:1050px){.brand{flex:1}.dashboard-grid,.lower{grid-template-columns:1fr}.pipeline{grid-template-columns:repeat(3,1fr)}}@media(max-width:650px){.topbar{padding:0 14px}.content{padding:20px 14px 40px}.rail{display:none}.content{margin-left:0;width:100%}.kpis{grid-template-columns:repeat(2,1fr)}.hero-row{align-items:flex-start;flex-direction:column}.filters{width:100%;flex-wrap:wrap}.filter{flex:1;min-width:130px}.pipeline{grid-template-columns:1fr 1fr}.brand{min-width:0}.brand div{display:none}.top-actions .search{display:none}}
</style>
</head>
<body>
<div class="app">
<header class="topbar">
<a class="brand" href="dashboard.php"><img src="images/logo.webp" alt="GET"><div><strong>Ganda Elang Tangguh</strong><small>Customer Relationship Management</small></div></a>
